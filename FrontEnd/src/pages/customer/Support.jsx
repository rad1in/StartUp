...
export default function Support() {
  ...
  // Live-refreshes the ticket list (new message bumps a ticket to the top)
  // whenever the currently-open thread isn't handling the update itself.
...
function TicketThread({ ticketId, onBack }) {
  ...
  useCustomerSocket(user?.id, {
    'support:update': (payload) => {
      if (payload?.ticketId === ticketId) load();
    },
  });
