  ...
  return (
    <div className="max-w-lg">
      ...
      <Card className="mt-3">
        ...
        <p className="text-xs text-gray-500 mb-1">{t('orderDetail.orderDate')} {date(order.createdAt)}</p>
        ...
        <ul className="divide-y divide-gray-100 my-3">
          {order.items.map((item) => (
            <li key={item.id} className="py-2 flex items-center justify-between text-sm">
              ...
              <span>{n(Number(item.subtotal))} {t('menu.toman')}</span>
            </li>
          ))}
        </ul>
        ...
        {Number(order.discountAmount) > 0 && (
          <div className="mb-1">
            <div className="flex items-center justify-between text-sm text-ink font-medium">
              ...
              <span>-{n(Number(order.discountAmount))} {t('menu.toman')}</span>
            </div>
        ...
        <div className="flex items-center justify-between font-bold mb-4">
          ...
          <span>{n(Number(order.totalAmount))} {t('menu.toman')}</span>
        </div>
