        ...
        <Card key={plan.tier}>
          <button className="w-full flex items-center justify-between" onClick={() => setExpandedTier(expandedTier === plan.tier ? null : plan.tier)}>
            <div className="flex items-center gap-3">
              ...
              {plan.monthlyPrice > 0 && <span className="text-sm text-gray-500">{t('admin.planConfig.monthlyLabel')}: {n(Number(plan.monthlyPrice))} {t('common.toman')}</span>}
            </div>
        ...
        <Card>
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            ...
            <p className="text-xs text-blue-600 mt-1">
              ...
              {' '}{n(Number(trialSettings.revenueThreshold))} {t('common.toman')} {t('admin.planConfig.dynamicTrialLogicPart3')}
