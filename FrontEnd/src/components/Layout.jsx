      ...
      <footer className="mt-10 border-t border-black/5 bg-surface-2/40 backdrop-blur-sm pb-24 md:pb-0">
        <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col items-center gap-5">
          ...
          <a
            ...
            href="https://trustseal.enamad.ir/?id=763119&Code=h26g6sP4AKPcVx6EEqKKDc8c3A7teLAn"
          >
            <img
              referrerPolicy="origin"
              src="https://trustseal.enamad.ir/logo.aspx?id=763119&Code=h26g6sP4AKPcVx6EEqKKDc8c3A7teLAn"
              alt="نماد اعتماد الکترونیکی"
              style={{ cursor: 'pointer' }}
              code="h26g6sP4AKPcVx6EEqKKDc8c3A7teLAn"
            />
          </a>
