        ...
        <div className="space-y-2">
          {payouts.map((payout) => (
            <div key={payout.id} className="flex items-center justify-between text-sm border-b border-gray-100 pb-1">
              ...
              <span className="text-gray-500">{Number(payout.amount).toLocaleString('fa-IR')} {t('common.toman')}</span>
        ...
        <div className="space-y-2">
          {refunds.map((refund) => (
            <div key={refund.id} className="flex items-center justify-between text-sm border-b border-gray-100 pb-1">
              ...
              <span className="text-gray-500">{Number(refund.amount).toLocaleString('fa-IR')} {t('common.toman')}</span>
