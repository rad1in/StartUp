      ...
      {open && (
        <div className="absolute left-0 mt-2 w-80 max-h-[26rem] overflow-y-auto glass-strong rounded-2xl shadow-lift z-50 animate-pop-in" dir="rtl">
          <div className="flex items-center justify-between px-4 py-3 border-b border-ink/10">
            <p className="font-bold text-ink text-sm">اعلان‌های داخلی</p>
            {unread > 0 && (
          ...
          {items.length === 0 ? (
            <p className="text-xs text-ink/40 text-center py-8">اعلانی وجود ندارد.</p>
          ) : (
                ...
                const content = (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-ink/35 mt-1">{new Date(n.createdAt).toLocaleString('fa-IR')}</p>
                    </div>
                  </div>
                );
                return n.link ? (
