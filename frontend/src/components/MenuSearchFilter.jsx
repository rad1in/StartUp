      ...
      {open && (
        <div className="card-luxe p-4 mt-2 space-y-4 animate-pop-in">
          <label className="flex items-center justify-between cursor-pointer">
            <span className="text-sm font-bold text-ink">فقط قابل سفارشی‌سازی</span>
            <input
              type="checkbox"
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-sm font-bold text-ink">حداکثر قیمت</span>
              <span className="text-xs text-accent-700 font-bold">{maxPrice.toLocaleString('fa-IR')} تومان</span>
            </div>
            <input
              type="range"
              min={0}
