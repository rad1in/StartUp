...
import { Image, Linking, Platform, Pressable, ScrollView, SectionList, StyleSheet, View } from 'react-native';
              ...
              <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
                ...
                {!!venue.lat && !!venue.lng && (
                  <View style={styles.infoMapWrap}>
                    ...
                    >
                      <Marker coordinate={{ latitude: Number(venue.lat), longitude: Number(venue.lng) }} />
                    </MapView>
                  </View>
                )}
