      ...
      <Card style={{ padding: 0, overflow: 'hidden', borderRadius: radius.xxl }}>
        <View style={styles.coverWrap}>
          ...
          <View style={styles.overlayText}>
            <T style={{ fontFamily: fonts.black, fontSize: 19, lineHeight: 24, color: colors.ink }} numberOfLines={1}>
              {venue.name}
            </T>
...
const styles = StyleSheet.create({
  coverWrap: { width: '100%', height: 190, backgroundColor: colors.surfaceHigh },
