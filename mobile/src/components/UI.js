...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.black, fontSize: 26, lineHeight: 34, color: colors.ink },
  muted: { color: colors.inkMuted, fontSize: 14 },
  screen: { flex: 1, backgroundColor: colors.bg },
  // Pure flat color blocks, no border, no shadow — separation between cards
  // comes from generous margin and background contrast only.
  card: {
    backgroundColor: colors.surface,
    borderRadius: radius.xl,
    padding: 18,
  },
  cardGold: { backgroundColor: colors.surfaceHigh },
  goldCard: {
    borderRadius: radius.xl,
    overflow: 'hidden',
    padding: 22,
