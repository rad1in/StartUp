...
export function AuthProvider({ children }) {
  ...
  async function login(email, password, captchaExtra = {}) {
    const { data } = await api.post('/auth/login', { email, password, ...captchaExtra });
  ...
  async function requestLoginOtp(phone, captchaExtra = {}) {
    const { data } = await api.post('/auth/login/otp/request', { phone, ...captchaExtra });
    return data;
  }
