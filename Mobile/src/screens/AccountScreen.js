...
const CUSTOMER_ITEMS = [
  { icon: 'file-text', key: 'myOrders', path: '/orders' },
...
export default function AccountScreen() {
  ...
  return (
    ...
    >
      ...
      {/* Not required inside the app (only the web footer must show it), but
          there's room here so it's shown for extra trust/legitimacy too. */}
      <Pressable
        onPress={() => Linking.openURL('https://trustseal.enamad.ir/?id=763119&Code=h26g6sP4AKPcVx6EEqKKDc8c3A7teLAn')}
        style={{ alignItems: 'center', marginTop: 18, marginBottom: 4 }}
      >
        <Image
          source={{ uri: 'https://trustseal.enamad.ir/logo.aspx?id=763119&Code=h26g6sP4AKPcVx6EEqKKDc8c3A7teLAn' }}
